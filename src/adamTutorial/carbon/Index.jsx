                ...
                <div className="flex justify-between">
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center text-gray-600">
                            ...
                            <input placeholder="Search Game" className="bg-gray-900 font-medium text-sm -ml-8 pl-12 w-64  py-3 rounded-lg" type="text" />
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="w-3/6 font-semibold grid gap-3 grid-rows-3 grid-cols-10">
                        ...
                        <div class="rounded-lg  col-span-4 gutter bg-gray-900 p-4 ">
                            ...
                            <div className="mt-2 relative">
                                ...
                                <div className="bg-red-500 w-3/12 absolute top-0  h-1 rounded-full"></div>
                            </div>
                        </div>
                        <div class=" overflow-hidden   relative rounded-lg  flex items-center justify-between col-span-4 gutter bg-gray-900 p-4 ">
